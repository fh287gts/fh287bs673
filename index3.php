    ...
    <style>
        ...
        * {
        ...
        .alert {
            ...
            font-size: 0.9rem;
            margin-bottom: 20px;
            animation: fadeOut 1s ease-out 10s forwards; /* Desaparece después de 10 segundos */
        }
        .alert span {
            flex: 1;
            text-align: left;
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        inputs.forEach((input, index) => {
            input.addEventListener('input', (e) => {
                // Si se escribe un dígito válido, pasar al siguiente campo
            ...
            input.addEventListener('keydown', (e) => {
                // Si se presiona Backspace en un campo vacío, volver al anterior
                if (e.key === 'Backspace' && e.target.value === '' && index > 0) {
                    inputs[index - 1].focus();
                }
            });

            // Prevenir entrada de más de un dígito o caracteres no numéricos
...
<body>
    <div class="banner">
        <div class="alert">
            <span><span class="checkmark">✔</span> El código de seguridad fue enviado.</span>
